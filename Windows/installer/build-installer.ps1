...
function Install-PythonDependencies {
    ...
    $requirementsPath = Join-Path $PROJECT_ROOT "requirements-runtime.txt"

    Write-Host "  Installing from requirements-runtime.txt (runtime dependencies only)..." -ForegroundColor Cyan
